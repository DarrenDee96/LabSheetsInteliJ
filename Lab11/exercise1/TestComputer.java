...
public class TestComputer {
    public static void main(String[] args) {
        ...
        Computer c5 = new Computer("Lenovo", "Desktop", 2.86, 14, 547.34);
        ...
        System.out.println("\n\nSome additional information\n\nAverage computer price is: €" + String.format("%.2f",totalPrice/allComputers.length)+
                           "\nDetails of highest speed computer: " + highestSpeedComputer +
                            "\nThe Computers over 500 are: " + str + "\n The tablets are: " + tabstr);

            System.out.println("\n\nupdate details of allComputers in Array\n");
        for (Computer l : allComputers){
            if(l.getManufacturer() == "Lenovo"){
                l.setManufacturer("Dell");
            }
